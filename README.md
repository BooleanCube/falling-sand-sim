...
```console
boole@ncube:~$ chmod -x path/to/jar/fallingsandsim.jar // This converts the `jar` file in an executable `jar` file. boole@ncube:~$ java -jar path/to/jar/fallingsandsim.jar
```
